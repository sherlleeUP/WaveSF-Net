...
#def get_args():
    ...
    #arg("-c", "--config_path", type=Path, default=Path("/remote-home/public2/NEW/config/whubuilding/whu_cfg.py"),
        #help="Path to the config. Default is /remote-home/public2/NEW/config/whubuilding/whu_cfg.py")
    #args = parser.parse_args()
    #args.config_path = Path("/remote-home/public2/NEW/config/whubuilding/whu_cfg.py")
    #return args
