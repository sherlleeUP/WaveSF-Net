...
class MassBuildDataset(Dataset):
    def __init__(self, data_root= "/remote-home/public2/NEW/data/mass/png/tr/",  mode='train', img_dir='images', mask_dir='masks',
    ...
    def load_img_and_mask(self, index):
        ...
        img = cv2.resize(img, self.img_size)  # 调整图像大小
        img = img.astype(np.uint8)
        mask = cv2.imread(mask_name, cv2.IMREAD_UNCHANGED)
        mask = cv2.resize(mask, self.img_size, interpolation=cv2.INTER_NEAREST)  # 调整掩码大小
